...
#
# 构建：docker build -t crossroads-agent-cafe:latest .
# 运行：docker run -d --name coffee -p 8000:8000 --env-file .env crossroads-agent-cafe:latest
