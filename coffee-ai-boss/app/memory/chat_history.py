# ============================================================
# 【面试题·任务一·2】Redis 记忆设计：用 List 保存最近 5 轮聊天记录
#
# 为什么选 List 数据结构？
# 1. 天然按写入时间有序（LPUSH 最新在前，不用额外排序）
# 2. LPUSH + LTRIM 0 (2N-1) 恰好是「滑动窗口」，保留最近 N 轮
# 3. 读写均为 O(1)~O(N)，轻量高效，适合聊天场景
# 4. EXPIRE 实现「30 分钟无活动即遗忘」的短期记忆语义
#
# 每轮 = 用户消息 + AI 回复 = 2 条，故 5 轮保留条数 = 5 * 2 = 10 条
# ============================================================
